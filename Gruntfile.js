...
/*
 * Provides tasks for building and testing the jec-cheetoh project.
 */
module.exports = function(grunt) {
  ...
  //--> Task: builds the "jec-cheetoh" project:
  grunt.registerTask("build", ["ts:build", "copy:main",
                               "copy:initTypes", "copy:buildTypesFile",
                               "clean:build"]);

  //--> Task: builds the "jec-cheetoh" API documentation:
